const Phrases: string[] = [
    ...
    "I was so embarrassed when my mom showed my date my baby photos where I was wearing nothing but a [w].",
    ...
    "In a surprising new law, the city has banned [w], claiming it's for the public good.",
